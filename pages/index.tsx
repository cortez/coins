  ...
  return (
    <>
      ...
      <Fade cascade damping={0.1} duration={500}>
        <Link href="/">
          <div className="logo-wrapper copy-button shrink"><img className="logo" src="https://cdn.raster.app/mo3ymucdlps90r/coins/HqIqKj4eQc?ixlib=js-3.8.0&s=0ad631e727c5ab2b3067e05fb8be3ff0" alt="Coins Logo" />
        ...
        <div className="hero-header">
          ...
          <Fade cascade damping={0.1} duration={500}>
            <p className="username-input-text">
              ...
              <input className="username-input" ref={newLink} placeholder="new-username" value={route} onChange={handleChange} onKeyDown={handleKeyDown} />
      ...
      <Fade cascade damping={0.1} duration={200}>
        <img className="iphone-image" src="https://cdn.raster.app/mo3ymucdlps90r/coins/LM4GHVa93c?ixlib=js-3.8.0&s=d207babcf2a35b59ab1c09db0605b606" alt="iPhone Image" />
        <img className="iphone-image-mobile" src="https://cdn.raster.app/mo3ymucdlps90r/coins/lqNv2So1F8?ixlib=js-3.8.0&s=d21fde3c4d02c638aeaade67d541149d" alt="iPhone Image" />
      </Fade>
    </>
  )
}